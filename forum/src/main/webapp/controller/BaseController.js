sap.ui.define([
	...
	"dhbw/mosbach/neuendorf03/forum/model/formatter"
	 ...
	 * @class dhbw.mosbach.neuendorf03.forum.controller.BaseController
	 * @augments sap.ui.core.mvc.Controller
	 */
	return Controller.extend("dhbw.mosbach.neuendorf03.forum.controller.BaseController", {

		/**
		 * Make the (static) formatters available in all sub-controllers
		 * @memberof dhbw.mosbach.neuendorf03.forum.controller.BaseController
		 */
		formatter: formatter,
